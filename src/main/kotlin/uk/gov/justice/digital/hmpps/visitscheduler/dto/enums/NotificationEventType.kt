...
enum class NotificationEventType(val reviewType: String, val description: String) {
  ...
  PRISONER_ALERT_ADDED_EVENT("Prisoner-alert-added", "new prisoner alert added"),
  PRISONER_ALERT_UPDATED_EVENT("Prisoner-alert-updated", "new prisoner alert updated"),
  ...
  COURT_VIDEO_APPOINTMENT_CREATED_OR_UPDATED_EVENT("Court-video-appointment-created-or-updated", "Court video appointment created or updated"),

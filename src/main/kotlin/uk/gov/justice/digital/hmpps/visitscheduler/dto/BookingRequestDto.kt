...
data class BookingRequestDto(
  ...
  @Schema(description = "Map of Person ID (nomis) of the visitor and their age (in years) at the time of booking", required = false)
  val visitorAges: Map<Long, Int?>? = null,
)

...
class OffenderNonAssociationDetailDto(
  @Schema(description = "Date and time the nom-association is effective from.", example = "2019-12-01", required = true)
  val effectiveDate: LocalDate,
  @Schema(description = "Date and time the nom-association expires.", example = "2019-12-01", required = false)

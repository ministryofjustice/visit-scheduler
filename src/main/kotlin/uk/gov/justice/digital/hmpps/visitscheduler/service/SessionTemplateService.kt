...
class SessionTemplateService(
  ...
  fun createSessionTemplate(createSessionTemplateDto: CreateSessionTemplateDto): SessionTemplateDto {
    ...
    val sessionTemplateEntity = SessionTemplate(
      ...
      adultOnly = createSessionTemplateDto.adultOnly,
      adultAgeThreshold = createSessionTemplateDto.adultAgeThreshold,
    )
  ...
  fun updateSessionTemplate(reference: String, updateSessionTemplateDto: UpdateSessionTemplateDto, validateRequest: Boolean): SessionTemplateDto {
    ...
    with(updateSessionTemplateDto) {
      ...
      adultOnly?.let {
        sessionTemplateRepository.updateAdultOnly(reference, adultOnly = it)
      }

      adultAgeThreshold?.let {
        sessionTemplateRepository.updateAdultAgeThreshold(reference, adultAgeThreshold = it)
      }
    }

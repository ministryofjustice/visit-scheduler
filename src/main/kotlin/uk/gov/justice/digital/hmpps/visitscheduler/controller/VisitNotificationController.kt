...
class VisitNotificationController(
  ...
  @PreAuthorize("hasRole('VISIT_SCHEDULER')")
  @PostMapping(VISIT_NOTIFICATION_PRISONER_ALERT_UPDATED_PATH)
  @ResponseStatus(HttpStatus.OK)
  @Operation(
    summary = "To notify VSiP that a prisoner alert has been updated",
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "notification has completed successfully",
  ...
  @PreAuthorize("hasRole('VISIT_SCHEDULER')")
  @PostMapping(VISIT_NOTIFICATION_COURT_VIDEO_APPOINTMENT_CREATED_PATH)
  @ResponseStatus(HttpStatus.OK)
  @Operation(
    summary = "To notify VSiP that a court video appointment has been created",
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "notification has completed successfully",
  ...
  @PreAuthorize("hasRole('VISIT_SCHEDULER')")
  @PostMapping(VISIT_NOTIFICATION_COURT_VIDEO_APPOINTMENT_UPDATED_PATH)
  @ResponseStatus(HttpStatus.OK)
  @Operation(
    summary = "To notify VSiP that a court video appointment has been updated",
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "notification has completed successfully",
  ...
  fun notifyVSiPThatCourtVideoAppointmentUpdated(
    @RequestBody @Valid
    dto: CourtVideoAppointmentNotificationDto,
  ): ResponseEntity<HttpStatus> {
    LOG.debug("Entered notifyVSiPThatCourtVideoAppointmentUpdated {}", dto)
    visitNotificationEventService.handleCourtVideoAppointmentUpdatedNotification(dto)
    return ResponseEntity(HttpStatus.OK)
  }
  ...
  fun getFutureNotificationVisits(
    ...
    @RequestParam(value = "types", required = false)
    notificationEventTypes: List<NotificationEventType>?,
  ): List<VisitNotificationsDto> = visitNotificationEventService.getFutureVisitsWithNotifications(prisonCode, notificationEventTypes)
  ...
  fun notifyVSiPOfPrisonerMerge(
    ...
    visitNotificationEventService.handlePrisonerMerge(dto)
    return ResponseEntity(HttpStatus.OK)
  }
}

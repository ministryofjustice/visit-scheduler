...
enum class ApplicationValidationErrorCodes(
  ...
  APPLICATION_INVALID_PRISON_NOT_MATCHING("Application prison code - does not match prisoner's prison code"),
  APPLICATION_INVALID_SESSION_NOT_AVAILABLE("Session not available to prisoner"),
  APPLICATION_INVALID_SESSION_TEMPLATE_NOT_FOUND("Session template nout found"),
  ...
  APPLICATION_INVALID_INADEQUATE_VO_BALANCE("No VO balance to book visit."),
  APPLICATION_INVALID_INADEQUATE_SLOT_CAPACITY("Not enough slots available."),
}

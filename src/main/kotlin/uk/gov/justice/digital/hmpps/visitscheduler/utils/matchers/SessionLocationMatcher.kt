...
@Component
class SessionLocationMatcher :
  SessionGroupMatcher<PermittedSessionLocationDto>,
  Comparator<PermittedSessionLocationDto> {
  ...
  ): Boolean = multipleLocationMatcher.test(primarySessionLocation, comparedSessionLocations)

  override fun hasAllMatch(o1: Set<PermittedSessionLocationDto>, o2: Set<PermittedSessionLocationDto>): Boolean = o2.isEmpty() ||
    o1.stream().allMatch {
  ...
  private fun getMatchLevel(o1: PermittedSessionLocationDto, o2: PermittedSessionLocationDto): LocationMatchLevel = if (o1 == o2) {
  ...
  override fun compare(o1: PermittedSessionLocationDto?, o2: PermittedSessionLocationDto?): Int = if (o1 != null && o2 != null) getMatchLevel(o1, o2).matchValue else -1
}

...
class FlagVisitTaskConfiguration(
  @param:Value("\${task.flag-visits.enabled:false}") val flagVisitsEnabled: Boolean,
  @param:Value("\${task.flag-visits.number-of-days-ahead:30}") val numberOfDaysAhead: Int,
) {
  companion object {

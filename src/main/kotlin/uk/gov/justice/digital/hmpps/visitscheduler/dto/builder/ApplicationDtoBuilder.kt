...
class ApplicationDtoBuilder {
  ...
  fun build(applicationEntity: Application): ApplicationDto {
    return ApplicationDto(
      ...
      startTimestamp = applicationEntity.sessionSlot.slotDate.atTime(applicationEntity.sessionSlot.slotTime),
      endTimestamp = applicationEntity.sessionSlot.slotDate.atTime(applicationEntity.sessionSlot.slotEndTime),

...
abstract class IntegrationTestBase {
  ...
  protected fun stubApplicationCreationHappyPathCalls(prisonerId: String, prisonCode: String) {
    ...
    prisonApiMockServer.stubGetVisitBalances(prisonerId, VisitBalancesDto(5, 5))

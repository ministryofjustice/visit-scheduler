...
class SessionConflictsUtilTest {
  ...
  fun `when non associations exists then session is marked with non-association session conflict`() {
    ...
    sessionConflictsUtil.addSessionConflicts(session, nonAssociationSessionsList, emptyList(), emptyList(), emptyList(), emptyList(), null, emptySet())
  ...
  fun `when booking for session does not exist then session is not marked with double booking session conflict`() {
    ...
    sessionConflictsUtil.addSessionConflicts(session, emptyList(), doubleBookingSessionList, emptyList(), emptyList(), emptyList(), null, emptySet())
    assertThat(session.sessionConflicts.size).isEqualTo(0)
  }
  ...
  fun `when booking exists for session but not for same date then session is not marked with double booking session conflict`() {
    val session = createVisitSessionDto(visitDate)
    sessionConflictsUtil.addSessionConflicts(session, emptyList(), emptyList(), emptyList(), emptyList(), emptyList(), null, emptySet())
    assertThat(session.sessionConflicts.size).isEqualTo(0)
  }
  ...
  fun `when date is not blocked by prison then session is not marked with prison blocked session conflict`() {
    ...
    sessionConflictsUtil.addSessionConflicts(session, emptyList(), emptyList(), emptyList(), prisonBlockedList, emptyList(), null, emptySet())
    assertThat(session.sessionConflicts.size).isEqualTo(0)
  }
  ...
  fun `when session is not blocked then session is not marked with session blocked session conflict`() {
    ...
    sessionConflictsUtil.addSessionConflicts(session, emptyList(), emptyList(), emptyList(), emptyList(), sessionBlockedList, null, emptySet())
    assertThat(session.sessionConflicts.size).isEqualTo(0)
  }
  ...
  fun `when multiple session conflicts then session is marked with all flagged session conflicts`() {
    ...
    sessionConflictsUtil.addSessionConflicts(session, nonAssociationSessionsList, doubleBookingSessionList, emptyList(), prisonBlockedList, sessionBlockedList, null, emptySet())
  ...
  @Test
  fun `when session template reference is adult only then session is marked with adult only conflict`() {
    val session = createVisitSessionDto(visitDate)
  ...
  @Test
  fun `when session template reference is not adult only then session is not marked with adult only conflict`() {
    val session = createVisitSessionDto(visitDate)
